 ...
 * @param type Tasa del impuesto. Default *0.16*
 * @param rate Tipo de impuesto. **NOTA** Sus valores pueden ser *IVA*, *ISR* y *IEPS*.
 * @param factor Tipo factor. **NOTA** Sus valores pueden ser *Tasa*, *Cuota* y *Exento*.
 * @param withholding Indica si se trata de un impuesto retenido *true*, o un impuesto
 * trasladado *false*.
